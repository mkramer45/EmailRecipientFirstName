...
cur5 = cursor5.execute('SELECT email, FirstName FROM Sendr_Usr WHERE RadioB = "Funny"')
info5 = cur5.fetchall()
conn5.commit()
conn5.close()
conn5.close()
...
message = j
m1 = 'dear' + str(tuple(firstN))
msg.attach(MIMEText(m1))
